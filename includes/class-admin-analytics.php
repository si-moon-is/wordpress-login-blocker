...
class LoginBlocker_Admin_Analytics {
    ...
    public function display_overview_tab($period) {
        ...
        <div class="login-blocker-stats-grid" style="margin-bottom: 20px;">
            <?php $this->admin->get_main_class()->display_stats_cards($period); ?>
        </div>
        
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="card">
                <h3>Próby logowania w czasie</h3>
                <?php $this->admin->get_main_class()->display_attempts_chart($period); ?>
            </div>
            
            <div class="card">
                <h3>Rozkład geograficzny</h3>
                <?php $this->admin->get_main_class()->display_country_stats($period); ?>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 20px;">
            <div class="card">
                ...
                <?php $this->admin->get_main_class()->display_top_users($period); ?>
            </div>
            
            <div class="card">
                <h3>Najaktywniejsze adresy IP</h3>
                <?php $this->admin->get_main_class()->display_top_ips($period); ?>
            </div>
        </div>
        <?php
    }
    ...
    public function display_countries_tab($period) {
        ...
        $country_stats = $wpdb->get_results($wpdb->prepare("
            ...
            FROM {$this->admin->get_table_name()} 
